                  ...
                  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                      <td style="text-align: left; padding-right: 10px;">
                      	...
                      	<p>We are an online design and printing company passionate about artistry and its difference to our customers and to the rest of the world. We intend to dent the planet with our brand and the artists we feature.</p>
                      </td>
                    </tr>
                  </table>
                </td>
                  ...
                  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                      <td style="text-align: left; padding-left: 5px; padding-right: 5px;">
                      	...
                      	<ul>
					                <li><span class="text">Phone: +1 408-835-0739</span></li>
					              </ul>
                      </td>
                    </tr>
                  </table>
...
<body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: #f1f1f1;">
    ...
    <ul>
        <li><strong>Signup/Login:</strong> Use your email to log in with the general password <strong>[password]</strong> (make sure to change it to your own unique password after logging in).</li>
        <li><strong>Your Own Ecommerce Shop:</strong> You now have a personal storefront on our site. It’s your space to display and sell your art, you can customize it too!</li>
        <li><strong>Product Mockup Generator:</strong> Turn your artwork into various products effortlessly with our new mockup generator tool. It’s designed to be simple and fun.</li>
                  ...
                  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                      <td style="text-align: left; padding-left: 5px; padding-right: 5px;">
                      	...
                      	<ul>
					                <li><span class="text">Phone: +1 408-835-0739</span></li>
                          <li><span class="text">Email: chi@politicozen.com</span></li>
					              </ul>
                      </td>
                    </tr>
                  </table>
